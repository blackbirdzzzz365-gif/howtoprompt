...
export const metadata: Metadata = {
  ...
  description:
    "Interactive handbook để học và vận hành đúng product loop OpenClaw x Codex trên runtime Linux VM thật.",
};
            ...
            <footer className="site-footer">
              <div>
                ...
                <p className="footer-copy">
                  ...
                  và guide authoritative để dạy owner dùng product loop đúng gate và đúng bot.
                </p>
              </div>
