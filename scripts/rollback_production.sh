...
image_ref="ghcr.io/${owner_lc}/${PROJECT_SLUG}:sha-${target_sha}"
...
APP_DIR="$APP_DIR" PROJECT_SLUG="$PROJECT_SLUG" DEPLOY_SHA="$target_sha" IMAGE_REF="$image_ref" PREVIOUS_HEAD="${current_sha}" scripts/deploy_production.sh
